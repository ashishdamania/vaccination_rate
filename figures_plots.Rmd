...
do(data.frame(rbind(Hmisc::smean.cl.boot(.$rate)))) %>%
  ...
  theme(text = element_text(size=18))+
     theme(legend.position = "none")+
  annotate("rect", ymin = 93, ymax = Inf, xmin=Inf,xmax = -Inf,alpha = .2,fill="green")
    ggsave("figures/Mean_vaccination_coverage_1995_2017_no_exemption.pdf", width = 30, height = 30, units = "cm")
```
...
annotate("rect", ymin = 90, ymax = 100, xmin=Inf,xmax = -Inf,alpha = .2,fill="green")
  ggsave("figures/Mean_vaccination_coverage_1995_2017.pdf", width = 30, height = 20, units = "cm")
```
...
states<-  sf::st_read("Raw_data/US_States_shape_file/cb_2017_us_state_20m/cb_2017_us_state_20m.shp") %>%
